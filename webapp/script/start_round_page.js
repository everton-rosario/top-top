var start_round_page = new function() {
	...
	$o.show = function() {
		$('#start_round .friend-game-img').attr('src', user_manager.getPicture(round_manager.current_round.friend, 'square'));
		$('#start_round .friend-name').html(user_manager.users[round_manager.current_round.friend].first_name);
