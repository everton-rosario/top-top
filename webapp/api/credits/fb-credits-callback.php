...
$app_secret = '38a530072ad113c4527859446a0e83f9';
...
if ($request_type == 'payments_get_items') {
  ...
  if ($item_id == '1a') {
    $item = array(
      'title' => '10 Top-Top Coins',
      'description' => 'Use seus créditos no Top-Top',
      // Price must be denominated in credits.
      'price' => 10,
      'image_url' => 'http://fortis4.com/top-top/img/coin.png',
    );
